...
// Función para procesar un mensaje con la IA de ventas
...
- Cliente envía comprobante de transferencia → Cambiar a "Revisar imagen"
`
  const prompt =
  `
...
- Si es un comprobante de pago Enviar a "Revisar imagen"
